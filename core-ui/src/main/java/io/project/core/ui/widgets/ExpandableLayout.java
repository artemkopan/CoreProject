...
/**
 *
 * Use attributes for child views:
 *
 * <code>
 *      <attr name="el_canExpand" format="boolean" />
 *      <attr name="el_startExpanded" format="boolean" />
 * </code>
 *
 *
 */
public class ExpandableLayout extends LinearLayout {
    ...
    private void playExpandAnimation(final View child) {
        ...
        expandAnimator.setDuration(getContext().getResources().getInteger(
    ...
    private void dispatchOffset(View child) {
        if (listener != null) {
            listener.onExpandOffset(this, child, child.getHeight(),
                    !isExpanded());
        }
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            canExpand = a.getBoolean(R.styleable.ExpandableLayout_el_canExpand,
                    false);
            isExpanded = a.getBoolean(R.styleable.ExpandableLayout_el_startExpanded,
                    false);
